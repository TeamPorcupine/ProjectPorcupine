...
namespace UnityDebugger
{
    ...
    public static class Debugger
    {
        ...
        /// <param name="message">Info to write.</param>
        /// <param name="context">Context.</param>
        public static void LogChannel(string channel, string message, Object context = null)
        {
            if (LogLevelEnabled(LogLevel.Info))
            {
                Debug.Log(message, context);
        ...
        /// <param name="message">Warning to write.</param>
        /// <param name="context">Context.</param>
        public static void LogWarningChannel(string channel, string message, Object context = null)
        {
            if (LogLevelEnabled(LogLevel.Warning))
            {
                Debug.LogWarning(message, context);
        ...
        /// <param name="message">Error to write.</param>
        /// <param name="context">Context.</param>
        public static void LogErrorChannel(string channel, string message, Object context = null)
        {
            if (LogLevelEnabled(LogLevel.Error))
            {
                Debug.LogError(message, context);
        ...
        /// <param name="exception">Exception to write.</param>
        /// <param name="context">Context.</param>
        public static void LogExceptionChannel(string channel, Exception exception, Object context = null)
        {
            if (LogLevelEnabled(LogLevel.Exception))
            {
                Debug.LogException(exception, context);
