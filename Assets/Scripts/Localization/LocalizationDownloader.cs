...
`'--.___  _\  /    |             Here        ,'    \)|\ `\|
    ...
    */
    ...
    public static class LocalizationDownloader
    {
        ...
        private static readonly string LocalizationRepositoryZipLocation = "https://github.com/QuiZr/ProjectPorcupineLocalization/archive/" + World.GameVersion + ".zip";

        // TODO: Change this to the official repo before PR.
        private static readonly string LastCommitGithubApiLocation = "https://api.github.com/repos/QuiZr/ProjectPorcupineLocalization/commits/" + World.GameVersion;
