...
namespace ProjectPorcupine.Noise
{
    public static class Noise
    {
        ...
        public static float[,,] GetPerlinNoiseMap(int mapWidth, int mapHeight, int mapDepth, int seed, float noiseScale, int octaves, float persistance, float lacunarity)
        {
            return GeneratePerlinNoiseMap(mapWidth, mapHeight, mapDepth, seed, noiseScale, octaves, persistance, lacunarity, new Vector2(0, 0.21f), NormalizeMode.Local);
        }
