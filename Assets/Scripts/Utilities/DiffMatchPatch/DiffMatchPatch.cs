...
namespace DiffMatchPatch
{
   ...
   */
     ...
     * @param diffs List of Diff objects.
     */
        public static void DiffCleanupSemantic(List<Diff> diffs)
        {
            bool changes = false;
     ...
     * @param diffs List of Diff objects.
     */
        public static void DiffCleanupSemanticLossless(List<Diff> diffs)
        {
            int pointer = 1;
     ...
     * @param diffs List of Diff objects.
     */
        public static void DiffCleanupEfficiency(List<Diff> diffs)
        {
            bool changes = false;
     ...
     * @param diffs List of Diff objects.
     */
        public static void DiffCleanupMerge(List<Diff> diffs)
        {
            // Add a dummy entry at the end.
            diffs.Add(new Diff(Operation.EQUAL, string.Empty));
            int pointer = 0;
     ...
     * @return Best match index or -1.
     */
        private static int match_bitap(string text, string pattern, int loc)
        {
     ...
     */
        private static Dictionary<char, int> match_alphabet(string pattern)
        {
     ...
     *      bool values.
     */
        public static Object[] patch_apply(List<Patch> patches, string text)
        {
            if (patches.Count == 0)
            {
            ...
            foreach (Patch patch in patches)
            {
                ...
                else
                {
                    ...
                    if (text1 == text2)
                    {
                        ...
                        text = text.Substring(0, start_loc) + diff_text2(patch.diffs)
                            ...
                            foreach (Diff diff in patch.diffs)
                            {
                                if (diff.operation != Operation.EQUAL)
                                {
                                    ...
                                    else if (diff.operation == Operation.DELETE)
                                    {
                                        // Deletion
                                        text = text.Remove(
                                            start_loc + index2, diff_xIndex(diffs, index1 + diff.text.Length) - index2);
                                    }
                                }
     ...
     */
        public static string patch_addPadding(List<Patch> patches)
        {
     ...
     */
        public static void patch_splitMax(List<Patch> patches)
        {
        ...
        */
        public static int DiffCommonPrefix(string text1, string text2)
        {
