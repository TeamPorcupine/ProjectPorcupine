...
public class PrototypeMap<T> where T : IPrototypable, new()
{
    ...
    private void LoadPrototype(XmlReader reader)
    {
        ...
        catch (Exception e)
        {
            ...
            Debug.LogError("Error reading '" + elementTag + "' prototype for: " + listTag + Environment.NewLine + "Exception: " + e.InnerException.Message + Environment.NewLine + "StackTrace: " + e.StackTrace);
        }
