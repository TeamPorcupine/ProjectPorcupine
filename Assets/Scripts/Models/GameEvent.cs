...
public class GameEvent 
{
    ...
    public void Update(float deltaTime)
    {
        ...
        foreach (string precondition in preconditions)
        {
            ...
            conditionsMet += (int)ActionsManager.GameEvent.Call(precondition, this, deltaTime).Number;
        }
    ...
    public void Execute()
    {
        if (executionActions != null)
        {
            ...
            ActionsManager.GameEvent.CallWithInstance(executionActions.ToArray(), this);
        }
