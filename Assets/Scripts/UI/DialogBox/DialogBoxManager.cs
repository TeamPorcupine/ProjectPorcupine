...
public class DialogBoxManager : MonoBehaviour
{
    ...
    public void Awake()
    {
        ...
        tempGoObj = (GameObject)Instantiate(Resources.Load("UI/BD_OptionsSlick"), controllers.transform.position, controllers.transform.rotation, controllers.transform);
